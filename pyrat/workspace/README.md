...
- Any other directory you create here can be imported the same way, with nothing to declare. \
...
Run this from the workspace, for instance after cloning it on another machine, or if one of the libraries it uses goes missing:
...
Renaming or moving your workspace needs nothing: your programs keep importing each other, wherever the workspace is.
