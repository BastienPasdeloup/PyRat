...
You can later add more directories in ``pyrat_workspace`` if you want to organize your programs differently, and they are importable the same way, with nothing to declare.
