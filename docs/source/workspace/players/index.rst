...
The ``TemplatePlayer`` defines the minimal implementation of a player, while the ``Random1``, ``Random2``, and ``Random3`` players are examples of players that make random moves.
